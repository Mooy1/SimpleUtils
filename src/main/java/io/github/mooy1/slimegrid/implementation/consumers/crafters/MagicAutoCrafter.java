...
public final class MagicAutoCrafter extends AbstractAutoCrafter {
    ...
    public MagicAutoCrafter() {
        super(GP, Items.MAGIC_AUTO_CRAFTER, new ItemStack[] {
    ...
    private Pair<MultiFilter, ItemStack> getSlimefunRecipe(@Nonnull SlimefunItem slimefunItem) {
        if (slimefunItem.getRecipeType() == RecipeType.MAGIC_WORKBENCH || slimefunItem.getRecipeType() == RecipeType.ANCIENT_ALTAR) {
